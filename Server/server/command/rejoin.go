...
type RejoinCommand struct {
}

func (RejoinCommand) Allow(src cmd.Source) bool {
	return Rejoin.Test(src)
}

func (RejoinCommand) PermissionMessage(src cmd.Source) string {
	return Rejoin.PermissionMessage(src)
}

func (r RejoinCommand) Run(src cmd.Source, o *cmd.Output, tx *world.Tx) {
